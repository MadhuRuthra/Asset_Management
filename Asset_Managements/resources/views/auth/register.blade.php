            ...
            <div class="row justify-content-center">
               <div class="col-md-10">
                  <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <div class="card-body">
                        <a href="{{route('dashboard')}}" class="navbar-brand d-flex align-items-center mb-3" style="margin-left:90px;">
                        <img src="http://localhost/asset_management/public/images/yeejai_logo.png" alt="" width="40" height="40">
