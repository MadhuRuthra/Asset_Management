<nav class="navbar navbar-expand-md navbar-light main-nav">
    <div class="container-fluid navbar-inner">
         <a href="{{route('landing-pages.index')}}" class="navbar-brand d-lg-none d-flex">
            ...
            <h5 class="logo-title ms-3">ASSET MANAGEMENT</h5>
        </a>
            ...
            <ul class=" navbar-nav iq-nav-menu list-unstyled">
                <li class="nav-item">
                    ...
                    <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                       ...
                       <li class="nav-item"><a class="nav-link {{activeRoute(route('landing-pages.ecommerce'))}}" href="{{route('landing-pages.ecommerce')}}">Ecommerce Landing Page</a></li>
                       <li class="nav-item"><a class="nav-link {{activeRoute(route('landing-pages.saas'))}}" href="{{route('landing-pages.saas')}}">Sass Landing Page</a></li>
                       ...
                       <li class="nav-item"><a class="nav-link {{activeRoute(route('landing-pages.startup'))}}" href="{{route('landing-pages.startup')}}">Startup Landing Page</a></li>
                    </ul>
                </li>
