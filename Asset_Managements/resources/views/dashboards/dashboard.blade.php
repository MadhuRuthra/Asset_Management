               ...
               <ul class="swiper-wrapper list-inline m-0 p-0 mb-2">
                  <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-01" class="circle-progress-01 circle-progress circle-progress-primary text-center" data-min-value="0" data-max-value="100" data-value="5" data-type="percent">
                           ...
                           <div class="progress-detail">
                              ...
                              @php
                              // Assuming $assets[3] is already an array
                              $totalValue = $assets[3]['total'] ?? 0;
                              @endphp
                              <h4 class="counter" style="visibility: visible;">{{ $totalValue }}</h4>
                           </div>
                        </div>
                     </div>
                  </li>

                  @foreach ($assets[2] as $record)
                  <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="900">
                     <div class="card-body d-flex align-items-center">
                        ...
                        <div class="progress-detail ml-3">
                              <p class="mb-2">{{ $record->asset_name }}</p>
                              <h4 class="counter">{{ $record->asset_managers_count > 0 ? $record->asset_managers_count : 0 }}</h4>
                        </div>
                     </div>
                  </li>
                  @endforeach
                  ...
                  <!-- <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1000">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-04" class="circle-progress-01 circle-progress circle-progress-info text-center" data-min-value="0" data-max-value="100" data-value="0" data-type="percent">
                           ...
                           <div class="progress-detail">
                              <p class="mb-2">USB</p>
                              <h4 class="counter" style="visibility: visible;">{{ $assets[4][3]->asset_managers_data ?? 0}}</h4>
                           </div>
                        </div>
                     </div>
                  </li>
                  ...
                  <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1100">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-05" class="circle-progress-01 circle-progress circle-progress-primary text-center" data-min-value="0" data-max-value="100" data-value="0" data-type="percent">
                              <svg class="card-slie-arrow " width="24px" height="24px" viewBox="0 0 24 24">
                                 <path fill="currentColor" d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z" />
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">printer</p>
                              <h4 class="counter">{{ $assets[5][3]->asset_managers_data ?? 0}}</h4>
                           </div>
                        </div>
                     </div>
                  </li>
                  ...
                  <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1200">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-06" class="circle-progress-01 circle-progress circle-progress-info text-center" data-min-value="0" data-max-value="100" data-value="0" data-type="percent">
                              <svg class="card-slie-arrow " width="24" viewBox="0 0 24 24">
                                 <path fill="currentColor" d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Mobiles</p>
                              <h4 class="counter">{{ $assets[3][3]->asset_managers_data ?? 0}}</h4>
                           </div>
                        </div>
                     </div>
                  </li>
                  ...
                  <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1300">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-07" class="circle-progress-01 circle-progress circle-progress-primary text-center" data-min-value="0" data-max-value="100" data-value="0" data-type="percent">
                              <svg class="card-slie-arrow " width="24" viewBox="0 0 24 24">
                                 <path fill="currentColor" d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Routers</p>
                              <h4 class="counter">{{ $assets[6][3]->asset_managers_data ?? 0}}</h4>
                           </div>
                        </div>
                     </div>
                  </li> -->
